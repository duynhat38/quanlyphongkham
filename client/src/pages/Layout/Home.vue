      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <router-link to="/quanlylichkham" class="nav-link" href="#" v-if="user.role=='tieptan'"
                ><i class="bi bi-people-fill"></i> Lịch Khám</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/khamchuabenh" class="nav-link" href="#" v-if="user.role=='bacsi'"
                ><i class="bi bi-bar-chart-line-fill"></i> Khám Chữa Bệnh</router-link
              >
            </li>
            <li class="nav-item">
              <router-link to="/quanlybenhnhan" class="nav-link" href="#" v-if="user.role=='admin'"
            ...
            <!-- <li class="nav-item dropdown">
              <a
                ...
                href="#"
                id="navbarDropdownThuChi"
                role="button"
                data-toggle="dropdown"
                aria-haspopup="true"
                aria-expanded="false"
              >
                <i class="bi bi-cash"></i> Thu Chi
              </a>
              <div class="dropdown-menu" aria-labelledby="navbarDropdownThuChi">
                <a class="dropdown-item" href="#">Phiếu Thu</a>
                <a class="dropdown-item" href="#">Phiếu Chi</a>
                <div class="dropdown-divider"></div>
                <a class="dropdown-item" href="#">Sổ Quỹ</a>
              </div>
            </li> -->
            <li class="nav-item dropdown">
              <a
        ...
        <ul class="nav justify-content-center">
          <li class="nav-item">
            <a class="nav-link" href="#"
              ><i class="bi bi-people-fill"></i> Bệnh Nhân</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"><i class="bi bi-inboxes"></i> Thuốc</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"
              ><i class="bi bi-layout-text-sidebar"></i> Đơn Thuốc</a
            >
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#"
              ><i class="bi bi-journal-text"></i> Hoá Đơn</a
            >
          </li>
        </ul>
      </footer>
