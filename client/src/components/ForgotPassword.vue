    ...
    <div class="vue-tempalte">
        <form>
            ...
            <div class="form-group">
                ...
                <input type="email" class="form-control form-control-lg" v-model="email" v-on:keyup.enter="forgotPassword()"/>
            </div>
            <div
            ...
            <div
                ...
                role="alert"
            >{{ success_message }}</div>
            <button type="button" class="btn btn-dark btn-lg btn-block mt-3" @click="forgotPassword()">Đặt Lại Mật Khẩu</button>
